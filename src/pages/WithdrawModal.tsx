...
export const WithdrawModal = (props: any): JSX.Element => {
  ...
  const defaultButtonStyle = 'bg-squash hover:bg-artySkyBlue text-white text-1em rounded-7 px-28 py-10 font-medium w-full flex justify-center uppercase items-center mx-10';
